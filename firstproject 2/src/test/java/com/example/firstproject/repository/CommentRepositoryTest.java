...
class CommentRepositoryTest {
    ...
    void findByArticleId() {
        ...
        /* Case 4 : 9999번 게시글의 모든 댓글 조회 */
        {
            ...
            // 검증
            assertEquals(expected, comments, "9999번 글은 존재하지 않음");
        ...
        /* Case 5 : -1번 게시글의 모든 댓글 조회 */
        {
            ...
            // 검증
            assertEquals(expected, comments, "-1번 글은 존재하지 않음");
    ...
    void findByNickname() {
        ...
        /* Case 2 : "Kim"의 모든 댓글 조회 */
        {
            ...
            Comment c = new Comment(8L, new Article(6L, "당신의 취미는?", "댓글 ㄱㄱㄱㄱ"), nickname, "유튜브");
            List<Comment> expected = Arrays.asList(a, b, c);
